...
<!--            :class="{now:nowLi==year.toString()+month.toString()+item.num}">-->
<!--          <span :class="{other:item.type==='other'}">{{item.num}}</span>-->
<!--        </li>-->
<!--      </ul>-->
<!--    </div>-->
<!--  </div>-->
...
<!--                    this.days.unshift({num: lastMonthDays - i, type: 'other'})-->
<!--                }-->
